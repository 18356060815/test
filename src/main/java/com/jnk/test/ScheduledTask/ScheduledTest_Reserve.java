...
////--------------------------------------------------------------------------------------无耻的分割线-------------------------------------------------------------------------
    ...
    public void bitcoin86_new_task() {
        ...
        dowloadPage_task.getbitcoin86DownLoadwk();//挖矿
...
//    }
    ...
    @Scheduled(fixedDelay = 600000)// 币原
    public void biyuan() {
        logger.error("币原---------------------------------");
        dowloadPage_task.biyuan();
    }

    @Scheduled(fixedDelay = 600000)// DAPP
    public void getDapp() {
        logger.error("币原---------------------------------");
        downLoadDapp.getDapp();
    }
