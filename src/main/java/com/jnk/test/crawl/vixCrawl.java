...
//        System.out.println(data1);
        ...
        map.put("desc","bee360");
        map.put("openid","oQmEa0qGhLnBFzfg52uL7i79_4s0");
        ...
        querymap.put("orderno","123456789");
        querymap.put("appid","wx9dda0127a53865e8");
        String plainTexts=map.get("appid").toString()+"OMSRN0Pl32rzIRkrOsIg4ADAevfF4Rv0J"+map.get("appid").toString();
