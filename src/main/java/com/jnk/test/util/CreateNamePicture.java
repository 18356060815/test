...
public class CreateNamePicture {
    ...
    public static String getPicUrl(String name,String id) throws Exception{
        generateImg(name, "F:/project",id);
        return "F:/project/"+id+".png";
    }
     ...
     * @throws IOException
     */
    public static void generateImg(String name, String outputPath, String id)
            throws IOException {
        int width = 100;
        int height = 100;
...
//                nameWritten = name.substring(nameLen - 2);
        ...
        String filename = outputPath + File.separator + id + ".png";
...
//        169,169,169
        String[] beautifulColors = new String[]{"169,169,169"};
